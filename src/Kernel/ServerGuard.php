...
use BaseSdk\Kernel\Contracts\MessageInterface;
use BaseSdk\Kernel\Exceptions\BadRequestException;
use BaseSdk\Kernel\Exceptions\InvalidArgumentException;
use BaseSdk\Kernel\Support\XML;
use BaseSdk\Kernel\Traits\Observable;
use BaseSdk\Kernel\Traits\ResponseCastable;
...
class ServerGuard
{
    ...
    /**
     * @var \BaseSdk\Kernel\ServiceContainer
     */
    protected $app;
     ...
     * @throws \BaseSdk\Kernel\Exceptions\InvalidArgumentException
     * @throws \BaseSdk\Kernel\Exceptions\InvalidConfigException
     */
     ...
     * @return $this
     *
     * @throws \BaseSdk\Kernel\Exceptions\BadRequestException
     */
     ...
     * Get request message.
     *
     * @return array|\BaseSdk\Kernel\Support\Collection|object|string
     *
     * @throws BadRequestException
     * @throws \BaseSdk\Kernel\Exceptions\InvalidArgumentException
     * @throws \BaseSdk\Kernel\Exceptions\InvalidConfigException
     ...
     * @param string                                                   $to
     * @param string                                                   $from
     * @param \BaseSdk\Kernel\Contracts\MessageInterface|string|int $message
     *
     * @return string
     *
     * @throws \BaseSdk\Kernel\Exceptions\InvalidArgumentException
     ...
     * @param string                                        $to
     * @param string                                        $from
     * @param \BaseSdk\Kernel\Contracts\MessageInterface $message
     *
     * @return string
     */
